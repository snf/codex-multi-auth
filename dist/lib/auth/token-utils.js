...
export function resolveRuntimeRequestIdentity(input) {
    ...
    return {
        accountId: resolveRequestAccountId(input.storedAccountId, input.source, tokenAccountId),
        email: sanitizeEmail(extractAccountEmail(input.accessToken, input.idToken)) ??
