...
export declare function configureBackendSettingsEntry(currentConfig: PluginConfig | undefined, deps: {
    configureBackendSettingsController: (currentConfig: PluginConfig | undefined, deps: {
...
//# sourceMappingURL=backend-settings-entry.d.ts.map