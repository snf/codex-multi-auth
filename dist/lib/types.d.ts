...
export type { PluginConfigFromSchema as PluginConfig, AccountIdSourceFromSchema as AccountIdSource, TokenSuccessFromSchema as TokenSuccess, TokenFailureFromSchema as TokenFailure, TokenResultFromSchema as TokenResult, TokenFailureReasonFromSchema as TokenFailureReason, } from "./schemas.js";
...
export type PromptCacheRetention = "5m" | "1h" | "24h" | "7d" | (string & {});
...
export type RequestToolDefinition = FunctionToolDefinition | ToolSearchToolDefinition | RemoteMcpToolDefinition | ComputerUseToolDefinition | ToolNamespaceDefinition | {
    type?: string;
    [key: string]: unknown;
};
