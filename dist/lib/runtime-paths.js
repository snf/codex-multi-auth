...
function pathsEqualNormalized(a, b) {
...
export function getCodexMultiAuthDir() {
    ...
    const isExplicitNonDefaultHome = codexHomeFromEnv.length > 0 && !pathsEqualNormalized(codexHomeFromEnv, defaultCodexHome);
 ...
 */
export function getLegacyCodexDir() {
