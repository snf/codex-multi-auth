...
function lookupMappedModel(modelId) {
 ...
 * routing.
 */
export function resolveNormalizedModel(model) {
    if (!model)
    ...
    if (normalized.includes("gpt-5.4-pro") ||
