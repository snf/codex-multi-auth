export const UI_COPY = {
    ...
    oauth: {
        ...
        loadLastBackupHint: (fileName, accountCount, savedAt) => `${fileName} | ${accountCount} account${accountCount === 1 ? "" : "s"} | saved ${savedAt}`,
        manualBackupHint: (accountCount, savedAt) => `${accountCount} account${accountCount === 1 ? "" : "s"} | saved ${savedAt}`,
        restoreBackupConfirm: (fileName, accountCount) => `Load ${fileName} (${accountCount} account${accountCount === 1 ? "" : "s"})?`,
        restoreBackupLoaded: (fileName, accountCount) => `Loaded ${fileName} (${accountCount} account${accountCount === 1 ? "" : "s"}).`,
        restoreBackupSyncWarning: "Backup loaded locally, but Codex auth sync did not complete. Multi-auth routing will still use the restored account pool.",
        goTo: "Go to:",
    ...
    settings: {
        title: "Settings",
        subtitle: "Customize startup, menu, behavior, backend, and experiments",
        ...
        experimentalHelpMenu: "Enter Select | 1 Sync | 2 Backup | 3 Guard | [ - Down | ] + Up | S Save | Q Back",
        ...
        startupSubtitle: "Control what runs before the Codex CLI starts",
        startupHelp: "Enter Toggle | 1 Toggle | B BestOnLaunch | S Save | Q Back (No Save)",
